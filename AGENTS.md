...
**Brain note (goals, backlog, full context):** [drug.md](file:///H:/My%20Drive/Brain2_backup/Projects/drug.md)
**GitHub:** https://github.com/p3ji/drug.git
**Stack (detected):** Python

## Run / build / test
- Run: `python <entry>.py` (identify the entry point)
